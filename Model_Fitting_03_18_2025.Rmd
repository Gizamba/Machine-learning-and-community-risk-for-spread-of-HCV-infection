...
```{r}
#main dataset
Aim_1_dat_2 <- read_csv("Aim_1_dat_2.csv") # Aim_1_dat_2 is similar to the Partial data provided in this repository. However, the HCV cases column was removed because that data has restricted access. 
